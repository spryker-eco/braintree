...
$config[BraintreeConstants::MERCHANT_ID] = 'cwd5zrcngwjmrfvg';
$config[BraintreeConstants::PUBLIC_KEY] = '6qpxzjnwqbnnsfyt';
$config[BraintreeConstants::PRIVATE_KEY] = '31d6202353068944bbceba4794cb7013';
$config[BraintreeConstants::ENVIRONMENT] = 'sandbox';
$config[BraintreeConstants::ACCOUNT_ID] = 'eu-de';
$config[BraintreeConstants::ACCOUNT_UNIQUE_IDENTIFIER] = '8zpxdw';
$config[BraintreeConstants::IS_VAULTED] = false;
$config[BraintreeConstants::IS_3D_SECURE] = false;
